  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error(
          "Erreur lors du chargement des conversations privées :",
          error
        );
            ...
            {filteredConversations.map((conversation) => (
              ...
              <div
                ...
                onClick={() => {
                  ...
                  // marquer comme lu toutes les notifications liees a cette conversation
                  notifications
                    .filter(
                      (n) =>
                        n.type === "message" && n.relatedId === conversation._id
                    )
              ...
              >
                {/* Avatar */}
                <img
                  src={conversation.otherParticipant?.avatar || userAvatar}
                  alt=""
                ...
                <div className="flex flex-col items-center w-1/4">
                  ...
                  {conversation.lastMessage && (
                    <span className="text-xs text-gray-500 text-end">
                      ...
                      {formatDistanceToNow(
                        new Date(conversation.lastMessage.date_envoi),
                        {
                          addSuffix: false,
                        }
                      )}
