...
const GroupDetail = () => {
    ...
    const getFileIcon = (type) => {
        return type.startsWith("image") ? <BsImage size={20} className="text-gray-500" /> : <BsFileText size={20} className="text-gray-500" />
    }
    ...
    if (!currentGroup) {
        return <div className="h-full min-w-[175px] flex flex-col bg-gray-50 rounded-lg ml-2 shadow-md overflow-hidden text-center text-gray-500 justify-center">Sélectionnez un groupe pour afficher les details.</div>;
    }
        ...
        <div className="h-full min-w-[175px] flex flex-col border-gray-200 border-2 bg-gray-50 rounded-lg ml-2 shadow-md overflow-hidden">
            <div className="p-3 border-gray-200">
                <div className="flex justify-between items-center p-2"> 
                    <h2 className="text-base font-semibold" >Membres ({ membres.length})</h2>
                    <AiOutlineUserAdd 
            ...
            <div className="flex-1 max-h-[300px] pb-2 overflow-y-auto custom-scrollbar"> 
                {filteredMembres.length > 0 ? (
                    ...
                    <p className="text-center text-gray-500">Aucun membre trouvé pour l&apos;instant</p>               
                )}
            ...
            <div className="flex-1 max-h-[300px] overflow-y-auto custom-scrollbar pb-3">
                {fichiers.length > 0 ? (
                    ...
                    <p className="text-center text-gray-500">Aucun fichier pour l&apos;instant</p>  
                )}
            ...
            <div className="fixed inset-0 bg-black bg-opacity-25 flex items-center justify-center z-50">
                <MembreAddModal onSelect={handleUserSelected} onClose={toggleMembreModal} />
            </div>
            )}
